...
public class ReviewServiceTests {
    ...
    public void ReviewService_CreateReview_ReturnReviewDto(){
        ...
        ReviewDto savedReview = reviewServiceImpl.createReview(user.getId(),animal.getId(),reviewDto);
    ...
    public void ReviewService_UpdateReview_ReturnReviewDto(){
        ...
        ReviewDto updateReview = reviewServiceImpl.updateReview(userId,animalId,reviewId,reviewDto);
    ...
    public void ReviewService_DeleteReview_ReturnReviewDto(){
        ...
        assertAll(()->reviewServiceImpl.deleteReview(userId,animalId,reviewId));
    }
}
